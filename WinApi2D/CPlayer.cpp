...
CPlayer::CPlayer()
{
	...
	CD2DImage* m_FiretoIdle = CResourceManager::GetInst()->LoadD2DImage(L"FiretoIdle", L"texture\\Animation\\PatriciaWagon\\Fire_Idle_to_Rest\\Fire_Idle_to_Rest_150_220.png");
	...
	GetAnimator()->CreateAnimation(L"JumpRise", m_JumpRise, fPoint(0.f, 0.f), fPoint(144.f, 228.f), fPoint(144.f, 0.f), fPoint(144.f, 228.f), 0, 0.120f, 4, true, false);
	GetAnimator()->CreateAnimation(L"R_JumpRise", m_JumpRise, fPoint(0.f, 0.f), fPoint(144.f, 228.f), fPoint(144.f, 0.f), fPoint(144.f, 228.f), 0, 0.120f, 4, true, true);
	GetAnimator()->CreateAnimation(L"JumpFall", m_JumpFall, fPoint(0.f, 0.f), fPoint(152.f, 220.f), fPoint(152.f, 0.f), fPoint(152.f, 220.f), 0, 0.100f, 4, true, false);
	GetAnimator()->CreateAnimation(L"R_JumpFall", m_JumpFall, fPoint(0.f, 0.f), fPoint(152.f, 216.f), fPoint(152.f, 0.f), fPoint(152.f, 220.f), 0, 0.100f, 4, false, true);
...
void CPlayer::update_State()
{
	...
	if (m_bAttacking && m_fAccelGravity > 0)
	{
...
void CPlayer::update_Move()
{
	...
	if (m_State == PLAYER_STATE::ATTACK && m_bGrounding)
	{
